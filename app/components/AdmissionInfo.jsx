    ...
    <div className="py-20 bg-gray-100">
      ...
      <section className="relative">
        <img
          ...
          alt="Don Bosco Vocational Training Center"
...
const CoursesSection = ({ title, description, courses }) => (
  <div className="mt-12">
    <h3 className="text-3xl font-semibold text-purple-900 mb-4">{title}</h3>
