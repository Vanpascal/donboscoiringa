...
const Dropdown = ({ label, items, isOpen, setIsOpen }) => (
  <li
...
function Header() {
  ...
  const dropdowns = [
    {
      ...
      items: [
        ...
        { href: "/about/management", label: "Our Policies" },
      ],
    },
    {
      label: "Admission",
    ...
    },
    {
      ...
      key: "projects",
      items: [
        { href: "/projeects/on-going", label: "On-going Projects" },
        { href: "/projeects/completed", label: "Completed Projects" },
      ],
    },
    {
  ...
  return (
    <header className="fixed top-0 w-full bg-purple-900 text-white py-4 z-50 shadow-lg">
        ...
        <ul className="hidden md:flex items-center space-x-6">
          ...
          {dropdowns.map(({ label, key, items }) => (
            <Dropdown
              ...
              setIsOpen={(isOpen) => toggleDropdown(key)}
            />
          ))}
          <li>
            <Link
